    ...
    <div className="min-h-screen max-w-[100vw] bg-black flex flex-col items-center w-[100vw] justify-center p-6 relative font-manrope">
      ...
      <div className="fixed top-0 left-0 w-full max-w-[100vw] z-30 bg-black/80 border-b border-[#23232A] flex items-center h-20 px-6 backdrop-blur-md md:hidden">
        ...
        >
          <Image
            ...
            width={120}
            height={60}
            className="h-16 w-auto transition-transform md:group-hover:scale-105"
          />
      ...
      <div className="hidden md:block">
        <a
          href="https://an3.io"
          rel="noopener noreferrer"
          className="fixed top-2 left-6 z-30 flex items-center group md:mt-0"
        >
          <Image
            src={An3Logo}
            alt="AN3 Logo"
      ...
      <div className="w-full max-w-7xl mx-auto relative mt-28 md:mt-8">
        ...
        <div className="text-center mb-10">
          <h1 className="text-7xl md:text-9xl font-bold mb-2 md:mb-6 flex items-center justify-center">
